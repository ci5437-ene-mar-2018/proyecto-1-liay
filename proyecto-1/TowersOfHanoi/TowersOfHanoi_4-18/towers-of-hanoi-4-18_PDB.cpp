...
void loadPDB(){
	FILE *f1 = fopen("towers-of-hanoi-4-18_abst_4-18_1.pdb","r");
	FILE *f2 = fopen("towers-of-hanoi-4-18_abst_4-18_2.pdb","r");

	abs1 = read_abstraction_from_file("towers-of-hanoi-4-18_abst_4-18_1.abst");
	map1 = read_state_map(f1);

	abs2 = read_abstraction_from_file("towers-of-hanoi-4-18_abst_4-18_2.abst");
