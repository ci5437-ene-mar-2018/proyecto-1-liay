...
void loadPDB(){
	FILE *f1 = fopen("24-puzzle_abst_24_1.pdb","r");
	FILE *f2 = fopen("24-puzzle_abst_24_2.pdb","r");
	FILE *f3 = fopen("24-puzzle_abst_24_3.pdb","r");
	FILE *f4 = fopen("24-puzzle_abst_24_4.pdb","r");

	abs1 = read_abstraction_from_file("24-puzzle_abst_24_1.abst");
	map1 = read_state_map(f1);

	abs2 = read_abstraction_from_file("24-puzzle_abst_24_2.abst");
	map2 = read_state_map(f2);

	abs3 = read_abstraction_from_file("24-puzzle_abst_24_3.abst");
	map3 = read_state_map(f3);

	abs4 = read_abstraction_from_file("24-puzzle_abst_24_4.abst");
